// lib/features/content_management/presentation/widgets/journeys/delete_journey_card.dart
...
class DeleteJourneyCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return StandardCard(
      ...
      onTap: () => JourneyManagementActions.fetchAndOpenDeleteJourneyDialog(
        context: context,
        ref: ref,
        onLoading: onLoading,
        onMessage: onMessage,
