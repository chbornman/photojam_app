// lib/features/content_management/presentation/widgets/journeys/update_journey_card.dart
...
class UpdateJourneyCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return StandardCard(
      ...
      onTap: () => JourneyManagementActions.fetchAndOpenUpdateJourneyDialog(
        context: context,
        ref: ref,
        onLoading: onLoading,
        onMessage: onMessage,
