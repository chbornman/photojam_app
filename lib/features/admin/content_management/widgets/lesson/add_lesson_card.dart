// lib/features/content_management/presentation/widgets/lessons/add_lesson_card.dart
...
class AddLessonCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return StandardCard(
      icon: Icons.add,
      title: "Add Lesson",
      onTap: () => LessonManagementActions.openAddLessonDialog(
        context: context,
        ref: ref,
        onLoading: onLoading,
        onMessage: onMessage,
