...
class AllJourneysPage extends StatelessWidget {
  ...
  const AllJourneysPage({super.key, required this.userId});

  Future<List<Map<String, dynamic>>> _fetchAllJourneys(
      BuildContext context) async {
    try {
      final databaseApi = Provider.of<DatabaseAPI>(context, listen: false);
      final response = await databaseApi.getAllActiveJourneys();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: _fetchAllJourneys(context),
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      FutureBuilder<List<Map<String, dynamic>>>(
                        future: Future.wait(journey['lessons']
                            .map<Future<Map<String, dynamic>>>(
                                (lessonUrl) async {
                          final title =
                              await _fetchLessonTitle(context, lessonUrl);
                        ...
                        builder: (context, lessonSnapshot) {
                          ...
                          return JourneyContainer(
                            ...
                            theme: theme,
                            onLessonTap: (lessonUrl) =>
                                _viewLesson(context, lessonUrl),
                          );
                        },
                      ),
                    ],
